...
function UILib.CreateWindow(libName, version, logoId)
    ...
    -- Stripe between main and side menu
    ...
    function TabHandling:Tab(tabText, tabId)
	  ...
	  -- Side bar buttons before selecting anything
        tabBtn.Name = "tabBtn"
	  ...
	  tabBtn.MouseButton1Click:Connect(
            function()
                        ...
                        for i, v in next, v:GetChildren() do
                            if v:IsA("TextButton") then
                                game.TweenService:Create(
                                    ...
                                    {
                                        TextColor3 = Color3.fromRGB(35, 59, 55)  -- Inactive side bar text color after clicking
                                    }
                                ):Play()
                            end
                ...
                game.TweenService:Create(
                    ...
                    TweenInfo.new(0.18, Enum.EasingStyle.Quint, Enum.EasingDirection.In),
                    {
                        TextColor3 = Color3.fromRGB(153, 255, 238)  -- Selected side bar item text color, match to tabBtn.TextColor3 above
                    }
                ):Play()
            end
        )
        ...
        function sectionHandling:Label(labelInfo)
            ...
            TextLabelFrame.Parent = newPage
            TextLabelFrame.BackgroundColor3 = Color3.fromRGB(21, 21, 21)
            TextLabelFrame.BackgroundTransparency = 1.000
            TextLabelFrame.Size = UDim2.new(1, 0, 0, 36)
        ...
        function sectionHandling:Section(sectionText)
            ...
            sectionExpannd.ImageColor3 = Color3.fromRGB(153, 255, 238) --Main header expand down arrow color
            sectionExpannd.ImageRectOffset = Vector2.new(564, 284)
            sectionExpannd.ImageRectSize = Vector2.new(36, 36)

            sectionExpannd.MouseButton1Click:Connect(
                function()
                    if isDropped then
                        isDropped = false
            ...
            sectionFrame.MouseButton1Click:Connect(
                function()
                    if isDropped then
                        isDropped = false
                        sectionFrame:TweenSize(UDim2.new(1, 0, 0, 36), "In", "Quint", 0.10)
                    ...
                    function()
                        if not debounce1 then
                            ...
                            game.TweenService:Create(
                                ...
                                TweenInfo.new(0.18, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                {
                                    BackgroundColor3 = Color3.fromRGB(101, 168, 157),  --Box color when mouse button clicked down
            ...
            function ItemHandling:Toggle(toggInfo, enabledByDefault, callback)
                ...
                enabledByDefault = enabledByDefault or false
                ...
                if enabledByDefault then
                    checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(153, 255, 238) --Toggle text color before selection
                    checkBtn.ImageColor3 = Color3.fromRGB(153, 255, 238) --Toggle box color before selection
                    checkBtn.ImageRectOffset = Vector2.new(4, 836)
                    checkBtn.ImageRectSize = Vector2.new(48, 48)
                    callback(on)
                end
                checkBtn.MouseButton1Click:Connect(
                    function()
                        if not togDe then
                            togDe = true
                            on = not on
                            if on then
                                checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(153, 255, 238) --Toggle text color after selecting and deselecting (set same as "if enabledByDefault then" above
                                checkBtn.ImageColor3 = Color3.fromRGB(153, 255, 238) --Toggle box color after selecting and deselecting (set same as "if enabledByDefault then" above
                                checkBtn.ImageRectOffset = Vector2.new(4, 836)
                                checkBtn.ImageRectSize = Vector2.new(48, 48)
                            else
                ...
                toggleFrame.MouseButton1Click:Connect(
                    function()
                        if not togDe then
                            ...
                            on = not on
                            if on then
                                checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(153, 255, 238) --Toggle text color for 2nd time selecting it
                                checkBtn.ImageColor3 = Color3.fromRGB(153, 255, 238) --Toggle box color for 2nd time selecting it
                                checkBtn.ImageRectOffset = Vector2.new(4, 836)
                                checkBtn.ImageRectSize = Vector2.new(48, 48)
                            else
                                checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(97, 97, 97)
                ...
                toggleFrame.MouseButton1Up:Connect(
                    function()
                        checkBtn.Parent:TweenSize(UDim2.new(0, 365, 0, 36), "InOut", "Quint", 0.18, true)
                    end
                )

                toggleFrame.MouseButton1Down:Connect(
                    function()
                        checkBtn.Parent:TweenSize(UDim2.new(0, 359, 0, 30), "InOut", "Quint", 0.18, true)
                    end
                )
            ...
            function ItemHandling:KeyBind(keyInfo, first, callback)
                ...
                key.Text = oldKey
                key.TextColor3 = Color3.fromRGB(153, 255, 238) --Keybind text color
                key.TextSize = 14.000
            ...
            function ItemHandling:TextBox(infbix, textPlace, callback)
                ...
                TextBox.BackgroundColor3 = Color3.fromRGB(153, 255, 238) --Input text box color
            ...
            function ItemHandling:Slider(slidInfo, minvalue, maxvalue, callback)
                ...
                dragSlider.BackgroundColor3 = Color3.fromRGB(153, 255, 238) --Drag slider color
                ...
                sliderbtn.MouseButton1Up:Connect(
                    function()
                        game.TweenService:Create(
                            dragPrecent,
            ...
            function ItemHandling:DropDown(dropInfo, list, callback)
                ...
                expand_more.ImageColor3 = Color3.fromRGB(153, 255, 238) --Submenus expand down arrow
                ...
                expand_more.MouseButton1Click:Connect(dropdown)
                ...
                dropdownItem1.TextColor3 = Color3.fromRGB(153, 255, 238) --Submenuse drop down text color
                ...
                for i, v in next, list do
                    ...
                    optionBtn1.MouseButton1Click:Connect(
                        function()
                            callback(v)
                    ...
                    optionBtn1.MouseButton1Down:Connect(
                        function()
                    ...
                    optionBtn1.MouseButton1Up:Connect(
                        function()
                            ...
                            game.TweenService:Create(
                                ...
                                TweenInfo.new(0.18, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                {
                                    BackgroundColor3 = Color3.fromRGB(101, 168, 157), --Color of box after mouse button released
                                    TextColor3 = Color3.fromRGB(0, 0, 0)
                                }
                            ):Play()
                        end
                        ...
                        function()
                            game.TweenService:Create(
                                ...
                                TweenInfo.new(0.18, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                {
                                    ...
                                    TextColor3 = Color3.fromRGB(250, 250, 250) --button color hovering
                                }
                            ):Play()
                        end
                    )

                    optionBtn1.MouseLeave:Connect(
                        function()
                            game.TweenService:Create(
                                optionBtn1,
                                TweenInfo.new(0.18, Enum.EasingStyle.Linear, Enum.EasingDirection.Out),
                                {
                                    BackgroundColor3 = Color3.fromRGB(21, 21, 21),
                                    TextColor3 = Color3.fromRGB(120, 200, 187) --button color after hover or selection
                                }
                            ):Play()
                        end
                    )
